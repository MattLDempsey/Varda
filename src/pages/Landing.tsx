...
const plans: PlanTier[] = [
  {
    ...
    features: [
      ...
      'Jobs kanban & table view',
      'Calendar (week view)',
      'Basic invoicing (1 per job)',
      'PDF quotes & invoices',
      'Customer quote page',
  ...
  },
  {
    ...
    features: [
      ...
      'Multi-line quotes with quick specs',
      'Full calendar (week, day, month + drag)',
      'Multi-invoice (deposit, progress, final)',
      'Expense tracking',
      'Full insights + smart alerts',
      'Email + WhatsApp comms',
      'Pricing rules',
    ],
  },
  {
    ...
    features: [
      'Everything in Pro',
      'Advanced insights (forecast, tax, margins)',
      'Team management + job assignment',
      'Granular permissions + activity log',
      'Custom job types',
      'CSV / Xero export',
      'Priority support',
    ],
